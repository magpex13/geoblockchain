...
use sp_consensus::{ Proposal, BlockOrigin };
use sc_consensus::{ BlockImportParams, import_queue::BoxBlockImport };
...
impl<Block, Algorithm, C, Proof> MiningWorker<Block, Algorithm, C, Proof>
	where
		Block: BlockT,
		C: sp_api::ProvideRuntimeApi<Block>,
		Algorithm: PowAlgorithm<Block>,
